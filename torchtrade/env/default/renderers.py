...
from torchtrade.oms.orders import TradeSide
from torchtrade.env.generic import Renderer, TradingEnv
...
class PlotlyTradingChart(BaseRenderer):
    """Trading visualization for TorchTrade using Plotly.
...
class MatplotlibTradingChart(BaseRenderer):
    """ Trading visualization for TorchTrade using Matplotlib
    Parameters
    ---------
    display : bool
        True to display the chart on the screen, False for not.
